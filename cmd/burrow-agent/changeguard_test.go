...
var agentCommandClasses = map[string]agentCommand{
	...
	"expose":        {mutates: true, why: "creates the Service and Ingress that expose an app", args: []string{"expose", "web", "--host", "app.example.com", "--port", "8080"}},
	"unexpose":      {mutates: true, why: "removes them again", args: []string{"unexpose", "web"}},
