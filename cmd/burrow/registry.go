...
func newRegistryCmd() *cobra.Command {
	...
	login := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintln(cmd.OutOrStdout(), o.targetClauseWhenDecided(fmt.Sprintf("configured registry %q for your apps", host)))
			return nil
		},
	}
	...
	logout := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			fmt.Fprintln(cmd.OutOrStdout(), o.targetClauseWhenDecided(fmt.Sprintf("removed registry %q", args[0])))
			return nil
		},
	}
