...
func TestDeployHappyPath(t *testing.T) {
	...
	saved, err := d.LatestRelease(ctx, "web", cp.DefaultEnvironment)
...
func TestRollbackNothingToRollBack(t *testing.T) {
	...
	// No releases at all.
	if _, err := e.Rollback(ctx, "web", "", cp.RollbackOptions{}); !errors.Is(err, cp.ErrNotFound) {
...
func TestRollbackGuardrailHolds(t *testing.T) {
	...
	_, err := e.Rollback(ctx, "web", "", cp.RollbackOptions{})
