...
// state they set up themselves. Resolving an agent connection reads the local config handles and
// checks their kube contexts against the ambient kubeconfig.
//
